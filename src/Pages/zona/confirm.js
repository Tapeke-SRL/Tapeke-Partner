...
import { SButtom, SDate, SHr, SIcon, SInput, SList, SLoad, SNavigation, SPage, SText, STheme, SView, SMapView } from 'servisofts-component';
    ...
    render() {
        ...
        return <SPage >
            <Container>
                ...
                <SView row col={"xs-12"}>
                    <SView col={"xs-6"}>
                        <SInput ref={ref => this._hi = ref} placeholder={"Hora Inicio"} defaultValue={this.params.hi} />
                    </SView>
                    <SView col={"xs-6"}>
                        <SInput ref={ref => this._hf = ref} placeholder={"Hora fin"} defaultValue={this.params.hf} />
                    </SView>
                </SView>
                <SHr height={32} />
                {this.renderButtom()}
