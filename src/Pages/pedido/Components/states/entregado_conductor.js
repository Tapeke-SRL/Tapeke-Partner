        ...
        return (
            <SPage >
                <SView col={"xs-12"} center height>
                    ...
                    <SView col={"xs-12"} backgroundColor={"#fff"} center>
                        <SHr height={32} />
                        <SText bold fontSize={16}>Dirígete al cliente para entregar el pedido</SText>
                        <SHr height={16} />
                        ...
                        <SView col={"xs-11"} center row>
                            ...
                            <SView flex>
                                <SText bold>{userClient.Nombres} {userClient.Apellidos}</SText>
                                <SText color={STheme.color.lightGray}>{userClient.Telefono}</SText>
                                {/* <SText color={STheme.color.lightGray}>{data.direccion.direccion}</SText> */}
                            </SView>
                        </SView>
                        <SHr height={8} />
                        <PButtom onPress={this.handleOnPress.bind(this)}>LLEGUÉ</PButtom>
                        {/* <SText fontSize={12} color={STheme.color.lightGray}>Recuerda que el restaurante debe escanear el QR para entregarte el pedido.</SText> */}
                        <SHr height={8} />
                    </SView>
                </SView>
            </SPage >
